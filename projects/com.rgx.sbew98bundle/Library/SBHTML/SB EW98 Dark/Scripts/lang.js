...
if (Lang == "de") {
    ...
    var hourtext = ["null", "ein", "zwei", "drei", "vier", "fünf", "sechs", "sieben", "acht", "neun", "zehn", "elf", "zwölf", "dreizehn", "vierzehn", "fünfzehn", "sechzehn", "siebzehn", "achtzehn", "neunzehn", "zwanzig", "einundzwanzig", "zweiundzwanzig", "dreiundzwanzig", "null"];
...
if (Lang == "tr") {
    ...
    var months=["Ocak","Subat","Mart","Nisan","May","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"];
    var shortmonths = ["Ock", "Sub", "Mar", "Nis", "Mayıs", "Haz", "Tem", "Ağu", "Eyl", "Eki", "Kas", "Ara"];
